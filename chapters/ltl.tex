...
\noindent Although from Theorem \ref{th:expr-ltl-pltl} \PLTL and \LTL have the same expressive power, it is worth to say that the \LTLf formalism augmented with past temporal operators present in \PLTL can be exponentially more succinct that \LTLf (with only future operators) \citep{markey2003temporal}.
