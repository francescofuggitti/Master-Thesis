\chapter{Planning for Extended Temporal Goals}\label{ch:planning}
...
Solving \FONDS problems for \LTLf/\PLTL goals of the form $\Diamond G$ is \EXPTIME-complete in the size of the domain.
\end{theorem}

At this point, we can start talking about the encoding process of \LTLf/\PLTL goals carried out in this thesis.
